...
hidden if the `arseniy-c_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `arseniy-c_DEVELOPER_MODE` to the configure
...
Runs the executable target `arseniy-c_exe`.
